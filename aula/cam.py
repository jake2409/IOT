...
cap = cv2.VideoCapture('MicrosoftTeams-video (1).mp4')  # Usa a webcam
...
LIMIAR_FECHAR = 0.10    # Se EAR cair abaixo disso, olho considerado fechado
LIMIAR_ABRIR = 0.17     # Se EAR subir acima disso, olho considerado aberto
